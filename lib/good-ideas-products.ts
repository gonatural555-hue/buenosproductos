...
const GOOD_IDEAS_PRODUCTS: Product[] = [
...

  {
    ...
    shortDescription:
      "Portable garment steamer for quick wrinkle removal at home or on the go — smart display, fast heating, multi-level temperature, and compact 5-in-1 design.",
    longDescription: [
      "Remove wrinkles quickly and practically with this portable 5-in-1 steam iron. Its compact body lets you freshen hanging clothes, last-minute outfits before heading out, and everyday garments without dedicating space to a traditional full-size iron and board.",
      "The steam system helps smooth shirts, tees, dresses, pants, and other garments without relying on a classic ironing table. Easy to store at home, ideal for apartments, travel, and daily touch-ups.",
      "Features a smart display, multi-level temperature control, fast preheating, and anti-scald / dry-burn protection for safer, more comfortable use.",
      "Depending on the kit you choose, the set may include a measuring cup, iron rest mat, mini ironing board, and a storage bag for the board.",
      "Important: every unit is brand new. Some units are steam-tested at the factory before shipping, so small water marks or residual moisture inside the tank can be normal and do not mean the product was previously used.",
    ],
    features: [
      "Powerful steam for quick wrinkle removal",
      "Compact, lightweight, and easy to use",
      "Smart display with visible functions",
      "Multi-level temperature control",
      "Ideal for shirts, tees, dresses, pants, and delicate garments",
      "Accessories included depend on the kit option selected",
      "24-hour offer available",
      "Fast heating",
      "Portable compact design for hanging clothes",
      "Steam function for wrinkle removal",
      "Anti-scald and dry-burn protection",
      "Practical for travel or daily use",
      "Easy to store",
      "Free shipping",
      "Product type: Portable steam iron / garment steamer",
      "Power: 1200 W",
      "Voltage: 220 V",
      "Plug type: EU",
      "Water tank capacity: Under 0.8 L",
      "Temperature levels: 5",
      "Dry burn protection: Yes",
      "Anti-scald protection: Yes",
      "Certification: RoHS",
      "Classification: Garment steamer / steam brush",
      "Use: Hanging ironing, quick touch-ups, garment steaming",
      "Supplier origin: CN",
      "Supplier brand: ZHUYIYAN",
      "Kit 1 includes: portable steamer, measuring cup, iron rest mat",
      "Kit 2 adds: mini ironing board",
      "Kit 3 adds: storage bag for the mini board",
      "Fill the tank with the measuring cup; wait for heat-up before steaming",
      "Do not exceed recommended tank capacity; empty after use",
      "Store dry and unplugged when not in use",
    ],
    freeShipping: true,
    variants: {
      type: "kit",
      label: "Kit",
      default: "steamer-cup-mat",
      options: [
        {
          value: "steamer-cup-mat",
          label: "Steamer + cup + mat",
          priceModifier: 0,
          compareAtPriceModifier: 0,
        },
        {
          value: "steamer-cup-mat-board",
          label: "Steamer + cup + mat + mini board",
          priceModifier: (135000 - 125000) / 1445,
          compareAtPriceModifier: (165000 - 150000) / 1445,
        },
        {
          value: "steamer-cup-mat-board-bag",
          label: "Steamer + cup + mat + board + bag",
          priceModifier: (145000 - 125000) / 1445,
          compareAtPriceModifier: (180000 - 150000) / 1445,
        },
      ],
    },
    translations: {
      es: {
        title: "Plancha a Vapor Portátil 5 en 1 para Ropa",
        salesBadge: "Oferta 24 hs",
        description:
          "Plancha/vaporizador portátil 5 en 1 para ropa con pantalla inteligente, calentamiento rápido, regulación de temperatura en varios niveles y diseño compacto. Sirve para vaporizar, planchar prendas colgadas y realizar retoques rápidos sin necesidad de una plancha tradicional grande.",
        shortDescription:
          "Vaporizador portátil para prendas, ideal para quitar arrugas rápido en casa o de viaje.",
        longDescription: [
          "Eliminá arrugas de forma rápida y práctica con esta plancha a vapor portátil 5 en 1. Su diseño compacto permite usarla en prendas colgadas, retoques rápidos antes de salir o para mantener la ropa prolija sin ocupar espacio.",
          "El sistema de vapor ayuda a alisar camisas, remeras, vestidos, pantalones y otras prendas sin depender de una tabla de planchar tradicional. Fácil de guardar en casa, ideal para departamentos pequeños, viajes y uso diario.",
          "Cuenta con pantalla inteligente, regulación de temperatura en varios niveles, calentamiento rápido y protección anti quemaduras en seco para un uso más cómodo y seguro.",
          "Según la opción elegida, el producto puede incluir vaso medidor, apoya plancha, mini tabla para planchar y bolsa de guardado.",
          "Aclaración importante: este producto es 100% nuevo. Para garantizar su correcto funcionamiento, cada unidad puede ser sometida a pruebas de vapor antes de salir de fábrica. Por este motivo, pueden quedar pequeñas manchas o restos de agua dentro del depósito. Esto es normal y no indica uso previo.",
        ],
        features: [
          "Vapor potente para quitar arrugas rápido",
          "Compacta, liviana y fácil de usar",
          "Pantalla inteligente con funciones visibles",
          "Regulación de temperatura en varios niveles",
          "Ideal para camisas, remeras, vestidos, pantalones y prendas delicadas",
          "Incluye accesorios según la opción elegida",
          "Oferta disponible por 24 horas",
          "Calentamiento rápido",
          "Diseño portátil y compacto para ropa colgada",
          "Función vapor para remover arrugas",
          "Protección anti quemaduras en seco",
          "Práctica para viajes o uso diario",
          "Fácil de guardar",
          "Envío gratis",
          "Tipo de producto: Plancha a vapor portátil / vaporizador de ropa",
          "Potencia: 1200 W",
          "Voltaje: 220 V",
          "Tipo de enchufe: EU",
          "Capacidad del tanque de agua: menor a 0,8 litros",
          "Regulación de temperatura: 5 niveles",
          "Función anti quemado en seco: Sí",
          "Protección anti quemaduras: Sí",
          "Certificación: RoHS",
          "Clasificación: Cepillo de vapor / garment steamer",
          "Uso: Planchar ropa colgada, retoques rápidos, vaporizado de prendas",
          "Origen proveedor: CN",
          "Marca del proveedor: ZHUYIYAN",
          "Opción 1 incluye: plancha a vapor portátil, vaso medidor y apoya plancha / mat",
          "Opción 2 agrega: mini tabla para planchar",
          "Opción 3 agrega: bolsa para guardar la tabla",
          "Cargar agua con el vaso medidor; esperar calentamiento antes de vaporizar",
          "No superar la capacidad recomendada del tanque; vaciar después del uso",
          "Guardar seco y desconectado cuando no se use",
        ],
      },
    },
  },
  ...
  {
    id: "gi-hogar-011",
    slug: "licuadora-biolomix-2200w-profesional",
    brand: "BioloMix",
    title: "BioloMix 2200W Heavy-Duty Professional Blender T5200",
    price: 320000 / 1445,
    compareAtPrice: 400000 / 1445,
    flashSaleHours: 24,
    salesBadge: "24h Offer",
    category: "Hogar",
    images: [],
    description:
      "BioloMix T5200 heavy-duty professional blender with up to 2200 W peak power, 45,000 RPM, six-wave stainless steel blades, 2 L BPA-free Tritan jar, 1–5 minute timer, and variable speed control. Choose from six kit options with tamper, 500 ml processor cup, spare parts, or extra 2 L jar.",
    shortDescription:
      "2200 W professional countertop blender with 2 L jar, timer, and six kit bundles — smoothies, soups, nut butters, and dry grinding.",
    longDescription: [
      "Power your kitchen with the BioloMix T5200 — a heavy-duty blender built for smoothies, green drinks, hot soups, sauces, nut butters, ice crushing, and dry grinding in one machine.",
      "The 2200 W motor (peak) with auto-compensation delivers up to 45,000 RPM through six-wave hardened stainless steel blades. Variable speed dial plus pulse give precise control; a 1–5 minute timer shuts off automatically.",
      "The 2 L (2000 cc) low-profile jar is FDA-certified, BPA-free Tritan — shatter-resistant with a rubber-covered handle. Jar safety switch prevents operation without the container seated.",
      "Overload reset and thermal protection help protect the motor during demanding blends. Elegant grey titanium-style base for everyday countertop use.",
      "Pick the kit that fits: tamper only, add a 500 ml processor cup, spare blade/accessory kit, extra 2 L jar, or full combinations. English user manual included; recipe PDF available on request.",
      "First use: run a small amount of water before heavy loads. A slight motor smell on first runs can be normal as factory lubricant heats. Jar is not dishwasher-safe — rinse promptly after use.",
    ],
    features: [
      "2200 W peak motor with auto-compensation",
      "Up to 45,000 RPM — six-wave stainless steel blades",
      "2 L BPA-free Tritan jar — wet and dry use",
      "Variable speed + pulse control",
      "1–5 minute timer with auto shut-off",
      "Jar safety switch — won't run without container",
      "Overload reset and thermal protection",
      "Ideal for smoothies, soups, nut butters, ice, dry grinding",
      "Six kit options with tamper and optional accessories",
      "24-hour offer available",
      "Free shipping",
      "Brand: BioloMix",
      "Model: T5200",
      "Voltage: 100–120 V / 220–240 V (plug variant per region)",
      "Control: Push-button / dial",
      "Housing material: Plastic",
      "Container material: Tritan",
      "Capacity: 1.8–2.1 L",
      "Style: Countertop / standing",
      "Speed settings: Continuous variable adjustment",
      "Number of blades: 6",
      "Function: Wet and dry application",
      "Origin: CN",
      "Kit 1: blender + tamper",
      "Kit 2 adds: 500 ml food processor cup",
      "Kit 3 adds: spare parts / replacement accessories",
      "Kit 4 adds: spare parts + 500 ml processor",
      "Kit 5 adds: extra 2 L jar",
      "Kit 6 adds: spare parts + extra 2 L jar",
    ],
    freeShipping: true,
    variants: {
      type: "kit",
      label: "Kit",
      default: "blender-tamper",
      options: [
        {
          value: "blender-tamper",
          label: "Blender + tamper",
          priceModifier: 0,
          compareAtPriceModifier: 0,
        },
        {
          value: "blender-processor-tamper",
          label: "Blender + 500 ml processor + tamper",
          priceModifier: (330000 - 320000) / 1445,
          compareAtPriceModifier: (415000 - 400000) / 1445,
        },
        {
          value: "blender-spare-tamper",
          label: "Blender + spare parts + tamper",
          priceModifier: (345000 - 320000) / 1445,
          compareAtPriceModifier: (430000 - 400000) / 1445,
        },
        {
          value: "blender-spare-processor-tamper",
          label: "Blender + spare parts + tamper + 500 ml processor",
          priceModifier: (360000 - 320000) / 1445,
          compareAtPriceModifier: (450000 - 400000) / 1445,
        },
        {
          value: "blender-jar-tamper",
          label: "Blender + extra 2 L jar + tamper",
          priceModifier: (380000 - 320000) / 1445,
          compareAtPriceModifier: (475000 - 400000) / 1445,
        },
        {
          value: "blender-spare-jar-tamper",
          label: "Blender + spare parts + tamper + extra 2 L jar",
          priceModifier: (450000 - 320000) / 1445,
          compareAtPriceModifier: (560000 - 400000) / 1445,
        },
      ],
    },
    translations: {
      es: {
        title: "Licuadora Profesional BioloMix 2200W T5200",
        salesBadge: "Oferta 24 hs",
        description:
          "Licuadora profesional BioloMix T5200 con hasta 2200 W de potencia pico, 45.000 RPM, 6 cuchillas de acero inoxidable, jarra Tritan libre de BPA de 2 L, temporizador de 1 a 5 minutos y control de velocidad variable. Elegí entre 6 opciones con palo mezclador, procesadora 500 ml, accesorios de repuesto o jarra extra de 2 L.",
        shortDescription:
          "Licuadora de mesa 2200 W con jarra de 2 L, temporizador y 6 kits — smoothies, sopas, mantecas de frutos secos y molienda seca.",
        longDescription: [
          "Potenciá tu cocina con la BioloMix T5200: licuadora de alta resistencia para smoothies, bebidas verdes, sopas calientes, salsas, mantecas de frutos secos, hielo y molienda seca en una sola máquina.",
          "Motor de 2200 W (pico) con auto-compensación y hasta 45.000 RPM mediante 6 cuchillas onduladas de acero inoxidable endurecido. Dial de velocidad variable más pulso; temporizador de 1 a 5 minutos con apagado automático.",
          "Jarra baja de 2 L (2000 cc) certificada FDA, Tritan libre de BPA, resistente a roturas, con mango recubierto de goma. Interruptor de seguridad: no funciona sin la jarra colocada.",
          "Reset por sobrecarga y protección térmica para uso exigente. Base elegante estilo titanio gris para el día a día.",
          "Elegí el kit que necesites: solo palo mezclador, procesadora 500 ml, kit de repuestos, jarra extra 2 L o combinaciones completas. Manual en inglés incluido; PDF de recetas disponible.",
          "Primer uso: probá con un poco de agua antes de cargas pesadas. Un leve olor del motor al inicio puede ser normal (lubricante de fábrica). La jarra no es apta para lavavajillas — enjuagá después de usar.",
        ],
        features: [
          "Motor 2200 W pico con auto-compensación",
          "Hasta 45.000 RPM — 6 cuchillas de acero inoxidable",
          "Jarra Tritan 2 L libre de BPA — uso húmedo y seco",
          "Velocidad variable + pulso",
          "Temporizador 1–5 min con apagado automático",
          "Interruptor de seguridad de jarra",
          "Reset por sobrecarga y protección térmica",
          "Ideal para smoothies, sopas, mantecas, hielo, molienda seca",
          "6 opciones de kit con palo mezclador y accesorios",
          "Oferta disponible por 24 horas",
          "Envío gratis",
          "Marca: BioloMix",
          "Modelo: T5200",
          "Voltaje: 100–120 V / 220–240 V (enchufe según región)",
          "Control: Botón / dial",
          "Material carcasa: Plástico",
          "Material jarra: Tritano",
          "Capacidad: 1,8–2,1 L",
          "Estilo: De pie / mesada",
          "Velocidades: Ajuste continuo",
          "Número de cuchillas: 6",
          "Función: Aplicación húmeda y seca",
          "Origen: CN",
          "Opción 1: licuadora + palo mezclador",
          "Opción 2 agrega: procesadora 500 ml",
          "Opción 3 agrega: accesorios de repuesto",
          "Opción 4 agrega: repuesto + procesadora 500 ml",
          "Opción 5 agrega: jarra extra 2 L",
          "Opción 6 agrega: repuesto + jarra extra 2 L",
        ],
      },
    },
  },
